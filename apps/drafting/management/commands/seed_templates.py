...
TEMPLATES = [
    {
        ...
        "sections": ["NIT", "ITB", "BDS", "Scope of Work", "Eligibility Criteria",
                     "Evaluation Criteria", "Bid Security (EMD)", "Performance Security",
                     "Integrity Pact", "Make in India", "MSE Preference", "GCC", "SCC"],
    ...
    },
    {
        ...
        "sections": ["NIT", "ITB", "Eligibility Criteria", "Evaluation Criteria",
                     "Bid Security (EMD)", "GCC"],
    ...
    },
    {
        ...
        "version": "v2026.06", "recommended": True,
        "sections": ["NIT", "ITB", "Terms of Reference", "Eligibility Criteria",
                     "Evaluation Criteria", "Integrity Pact", "GCC", "SCC"],
    ...
    },
    {
        ...
        "version": "v2026.06", "recommended": False,
        "sections": ["NIT", "Eligibility Criteria", "Pre-Qualification", "Evaluation Criteria"],
